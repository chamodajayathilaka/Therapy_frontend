...
function UpdateTherapist() {
 ...
 let navigate=useNavigate()
    ...
    const onSubmit=async(e)=>{
        e.preventDefault();
        await axios.put("http://localhost:8080/api/v1/therapist/updateTherapist",therapist)
        navigate("/");
    }
    const loadTherapist = async ()=>{
        const result=await axios.get("http://localhost:8080/api/v1/therapist/updateTherapist")
      ...
      justify-content-center align-items-center">
        ...
        <form onSubmit={(e)=>onSubmit(e)}>
            <div className="form-body">
                <div> 
                    <h3>Update Therapist Details </h3>
                </div>
